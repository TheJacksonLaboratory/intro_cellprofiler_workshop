...
- Create a `project` that has an associated image file list and an associated `pipeline` 
- Use the GUI to add a sequence of `modules` to develop the image analysis `pipeline`
...
- ensure image inputs and intermediate step outputs have meaningful names
