...
- Ensure you have the tutorial materials downloaded. We will use a sub of the official CellProfiler [Input Modules Tutorial materials](https://tutorials.cellprofiler.org/#input-modules). You can download the [`.zip file`](resources/InputModulesTutorialMaterials%20.zip).
